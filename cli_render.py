def help_info():
    ...
    print("  export openai <file>     export current context as OpenAI messages")
    print("  import openai <file>     import OpenAI messages")
    print("  export markdown <file>   export current context as Markdown")
